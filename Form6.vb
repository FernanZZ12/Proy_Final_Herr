...
Public Class Form6
    ...
    Private Sub Cambiarbtn_Click(sender As Object, e As EventArgs) Handles Cambiarbtn.Click
        ...
        If (IDPtxtbx.Text = "" Or IDCtxtbx.Text = "" Or Marcatxtbx.Text = "" Or Descriptxtbx.Text = "" Or Preciotxtbx.Text = "") Then
            MsgBox("No puede dejar espacios en blanco")
        Else
            If ds.Tables("Producto").Rows.Count > 0 Then
                Dim adaptador1 As New SqlCommand("update Producto set ID_Categoria ='" & IDCtxtbx.Text & "', Marca ='" & Marcatxtbx.Text & "',  Descripcion ='" & Descriptxtbx.Text & "',  Precio ='" & Preciotxtbx.Text & "' Where ID_Producto = '" & IDPtxtbx.Text & "'", gymbokuform.cn)
